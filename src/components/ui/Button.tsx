...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-surface-secondary-btn border border-surface-secondary-btn-border text-surface-text font-body font-semibold",
  ghost: "bg-transparent text-surface-ghost-text font-body font-semibold",
};
